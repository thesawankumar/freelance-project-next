                ...
                <div className="modal-body">
                  <form>
                    ...
                    <div className="mb-3">
                      ...
                      <select className="form-select" id="department" value={formData.department} onChange={(e) => setFormData({ ...formData, department: e.target.value })}>
                    ...
                    <div className="mb-3 form-check">
                      <input type="checkbox" className="form-check-input" id="defaultRole" checked={formData.DefaultRole} onChange={(e) => setFormData({ ...formData, DefaultRole: e.target.checked })} />
                      <label className="form-check-label" htmlFor="defaultRole">DefaultRole</label>
                    </div>
                    <div className="mb-3 form-check">
                      <input type="checkbox" className="form-check-input" id="sendMail" checked={formData.sendMail} onChange={(e) => setFormData({ ...formData, sendMail: e.target.checked })} />
