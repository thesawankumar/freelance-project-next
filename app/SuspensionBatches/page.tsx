...
const SuspendedBatches = () => {
  const [suspendedBatchesList, setSuspendedBatchesList] = useState<SuspendedBatchesData[] | null>([{batchId:1,
    accountNo:1,
...
// const targetUrl = 'https://postdrop.aacounty.org/email';
      ...
      console.log(from,to,"dtataaaata");
        ...
        <table className="table table-striped table-bordered table-hover">
          ...
          <tbody>
            {suspendedBatchesList
              ...
              : (
                <tr>
                  <td colSpan="5" className="text-center">No suspended batches found</td>
                </tr>
              )}
          </tbody>
        </table>
        ...
        <button
          onClick={() => {
            ...
            if (suspendedBatchesList) {
              SendSuspendEmail(`${user}@aacounty.org`, `${user}@aacounty.org`, suspendedBatchesList)
                .then((result) => {
                  if (result === 200) {
                    alert('Email sent');
                  } else {
